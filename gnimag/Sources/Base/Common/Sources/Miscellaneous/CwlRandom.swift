...
// This file provides performant alternatives to Swift's default RNG (arc4random). Use them when you need high-performant, non-secure, not necessarily well-distributed or unpredictable random numbers.
// Taken from https://github.com/mattgallagher/CwlUtils
