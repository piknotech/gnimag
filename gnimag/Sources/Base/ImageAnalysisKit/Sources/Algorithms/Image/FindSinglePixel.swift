...
extension Image {
    ...
    public final func findFirstPixel(matching match: ColorMatch, on path: PixelPath) -> Pixel? {
    ...
    public final func findLastPixel(matching match: ColorMatch, on path: PixelPath) -> Pixel? {
