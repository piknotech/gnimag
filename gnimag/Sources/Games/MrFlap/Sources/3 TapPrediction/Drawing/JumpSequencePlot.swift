...
final class JumpSequencePlot {
    ...
    convenience init(sequence: JumpSequenceFromSpecificPosition, playfield: PlayfieldProperties, jumping: JumpingProperties) {
        ...
        self.init(jumps: jumps, playfield: playfield)
    ...
    convenience init(sequence: JumpSequenceFromCurrentPosition, player: PlayerProperties, playfield: PlayfieldProperties, jumping: JumpingProperties) {
        ...
        self.init(jumps: [initialJump] + jumps, playfield: playfield)
    ...
    private init(jumps: [Jump], playfield: PlayfieldProperties) {
